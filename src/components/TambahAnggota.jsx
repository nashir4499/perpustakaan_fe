...
function TambahAnggota(props) {
    ...
    const saveAnggota = (e) => {
        e.preventDefault()
        setLoading(true)
        Axios.post('http://localhost:3333/anggota', {
            nama: data.nama,
            jk: data.jk,
            ttl: data.ttl,
            alamat: data.alamat,
        ...
        <div className="container-fluid mt-3 api">
            ...
            <form onSubmit={saveAnggota}>
                ...
                <div className="form-group">
                    ...
                    {/* <input type="text" className="form-control" value={data.jk} onChange={(e) => handleChange('jk', e.target.value)} /> */}
                ...
                <div className="form-group">
                    ...
                    <input type="tel" className="form-control" value={data.no_telpon} onChange={(e) => handleChange('no_telpon', e.target.value)} />
                </div>
                <div className="form-group">
                    <label>No KTP</label>
                    <input type="number" className="form-control" value={data.no_ktp} onChange={(e) => handleChange('no_ktp', e.target.value)} />
                </div>
